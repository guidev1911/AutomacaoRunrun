...
def criar_campo_senha(parent, placeholder_text):
    ...
    botao = ctk.CTkButton(
        ...
        height=28,
        corner_radius=8,
        command=lambda: alternar_senha(entry, botao)
    )
...
senha_runrun_frame, entry_senha = criar_campo_senha(
    fields_frame,
    "Digite a senha do Runrun"
)

senha_runrun_frame.grid(
    row=4,
    column=0,
    sticky="ew",
    pady=(0, 12)
...
saved_email = keyring.get_password(
    SERVICE_NAME_RUNRUN,
    "email"
)

saved_senha = keyring.get_password(
    SERVICE_NAME_RUNRUN,
    "senha"
)

saved_usuario_intr = keyring.get_password(
    SERVICE_NAME_DETRAN,
    "usuario_intr"
)

saved_senha_intr = keyring.get_password(
    SERVICE_NAME_DETRAN,
    "senha_intr"
)

saved_usuario_portal = keyring.get_password(
    SERVICE_NAME_DETRAN,
    "usuario_portal"
)

saved_senha_portal = keyring.get_password(
    SERVICE_NAME_DETRAN,
    "senha_portal"
)
